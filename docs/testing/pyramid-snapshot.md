...
_Generated: `2026-04-20T16:27:14.414Z`_
_Source workflow run id: `24677800512`_
_Head SHA: `308578a`_
...
| Integration (middle) | `api` / `integration` | **136** | 136 | 0 | 0 | 0 |
...
| --- | ---: |
| Unit (base) | 27.9% |
| Integration (middle) | 60.2% |
| UI / E2E (top) | 11.9% |

```text
Unit (base)    ███████ (63)
Integration (middle) ██████████████ (136)
UI / E2E (top) ███ (27)
```
